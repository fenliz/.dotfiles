...
nnoremap('<leader>dB', '<cmd>lua require"dap".set_breakpoint(vim.fn.input("Condition: "))<CR>', '<silent>', 'Debug: Set conditional breakpoint')
nnoremap('<leader>dl', '<cmd>lua require"dap".set_breakpoint(nil, nil, vim.fn.input("Message: "))<CR>', '<silent>', 'Debug: Set logpoint')


-- Fuzzy finder
nnoremap('<leader>dfm', '<cmd>lua require"telescope".extensions.dap.commands()<CR>', '<silent>', 'Debug: Find command')
nnoremap('<leader>dfc', '<cmd>lua require"telescope".extensions.dap.configuration()<CR>', '<silent>', 'Debug: Find configuration')
nnoremap('<leader>dfb', '<cmd>lua require"telescope".extensions.dap.list_breakpoints()<CR>', '<silent>', 'Debug: Find breakpoints')
nnoremap('<leader>dfv', '<cmd>lua require"telescope".extensions.dap.variables()<CR>', '<silent>', 'Debug: Find variables')
